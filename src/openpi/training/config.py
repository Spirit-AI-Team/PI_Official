...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        model=pi0.Pi0Config(action_horizon=60),
        exp_name = 'test',
        sample_weights_cfg = "/root/PI_Official/data/lerobot/MultiTask_PutStickOnTissue_0427/sample1.json",
        data=LeRobotAlohaDataConfig(
            repo_id=["MultiTask_PutStickOnTissue_0427"],
            assets=AssetsConfig(
                assets_dir="assets/spi0_aloha_eef_multi_full",
                asset_id=["MultiTask_PutStickOnTissue_0427"],
            ),
            adapt_to_pi=False,
            # interp_rate=3,
            repack_transforms=_transforms.Group(
