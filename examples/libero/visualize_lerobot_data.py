...
def main(num_episodes_to_visualize=1000):
    # set the LEROBOT_HOME and REPO_NAME to the dataset you need.
    LEROBOT_HOME = Path('/pfstem/lyc/dataset/lerobot/20250312_MultiTask4')
    ...
    for episodes_idx in episodes_idx_to_visualize:
        ...
        for data_idx in range(ep_start, ep_start+1):#ep_end):
            ...
            if "Pick up the kitchen paper" in prompt:
                print(value_dict['actions'])
            # import pdb
            # pdb.set_trace()
