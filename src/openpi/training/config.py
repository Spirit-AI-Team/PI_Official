...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        sample_weights_cfg="/pfstem/zhangshuo/pi0_MT_mvp/data_sample.json",
        checkpoint_base_dir="/pfstem/zhangshuo/checkpoints",
        data=LeRobotAlohaDataConfig(
            repo_id=["task1", "task2"],
            action_sequence_keys=('action', ),
            assets=AssetsConfig(
                assets_dir="/root/shuo/pi_dev/assets/spi0_aloha_finetune_full",
                asset_id=["task1", "task2"],
            ),
            adapt_to_pi=True,
            # default_prompt="fold the shirt",
            repack_transforms=_transforms.Group(
    ...
    TrainConfig(
        ...
        num_workers=4,
        fsdp_devices=2,
        weight_loader=weight_loaders.CheckpointWeightLoader("/pfstem/likaiyu/resources/checkpoints/spi0_aloha_finetune_lora3/shirtflatten_0225_base0223/29999/params"),
        num_train_steps=30_000,
