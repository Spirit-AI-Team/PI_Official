...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        model=pi0.Pi0Config(action_horizon=60),
        exp_name = 'test',
        sample_weights_cfg = "/pfstem/likaiyu/resources/lerobot/MultiTask_PutStickOnTissue_2missions_0429/sample1.json",
        data=LeRobotAlohaDataConfig(
            repo_id=["MultiTask_PutStickOnTissue_2missions_0429"],
            assets=AssetsConfig(
                assets_dir="assets/spi0_aloha_eef_multi_full",
                asset_id=["MultiTask_PutStickOnTissue_2missions_0429"],
            ),
            adapt_to_pi=False,
            # interp_rate=3,
            repack_transforms=_transforms.Group(
        ...
        keep_period = 5000,
        fsdp_devices=4,
        weight_loader=weight_loaders.CheckpointWeightLoader("/pfstem/limingzhu/checkpoints/spi0_aloha_eef_multi_full_v6/multi_task_op_v8_3/10000/params"),
        num_train_steps=20_000,
        lr_schedule = _optimizer.CosineDecaySchedule(decay_steps=25_000),
        checkpoint_base_dir="/pfstem/likaiyu/resources/checkpoints",
    ),
    TrainConfig(
