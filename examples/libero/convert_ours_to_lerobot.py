...
RIGHT_GRIPPER = 13 
FPS = 30
REPO_NAME = "MultiTask_PutEggInEggrack_0418"#"ALLShirt_EEF_0307_19"  # Name of the output dataset, also used for the Hugging Face Hub
...
for p in dataset_files:
    ...
    if 'PutEgggrack' in p:
        DATASET_TASK[p] = 'Put egg in eggrack'
