...
RIGHT_GRIPPER = 13
FPS = 30
REPO_NAME = "YC_WAIC_GiveAndReturnBottle_0619_20"#"ALLShirt_EEF_0307_19"  # Name of the output dataset, also used for the Hugging Face Hub
...
dataset_paths = [
                    ...
                    '/mnt/pfs-chihiro/20250619',
                    '/mnt/pfs-chihiro/20250620',
                ]
dataset_files = []
...
for p in dataset_files:
    ...
    if 'GiveAndReturnBottle' in p:
        DATASET_TASK[p] = 'GiveAndReturnBottle'
