...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        exp_name = 'test',
        data=LeRobotAlohaDataConfig(
            repo_id="FlattenShirt_EEF_0314_15",
            assets=AssetsConfig(
                assets_dir="assets/spi0_aloha_eef_vlm_freeze",
                asset_id="FlattenShirt_EEF_0314_15",
            ),
            adapt_to_pi=False,
            # interp_rate=3,
            # default_prompt="fold the shirt",
    ...
    TrainConfig(
        ...
        exp_name = 'test',
        data=LeRobotAlohaDataConfig(
            repo_id="Flatten_PickShirt_EEF_0317_20",
            assets=AssetsConfig(
                assets_dir="assets/spi0_aloha_eef_full2",
                asset_id="Flatten_PickShirt_EEF_0317_20",
            ),
            adapt_to_pi=False,
            # delta_base='actions',
            # interp_rate=3,
        ...
        num_workers=8,
        fsdp_devices=4,
        weight_loader=weight_loaders.CheckpointWeightLoader("/root/PI_Official/data/checkpoints/spi0_aloha_eef_full3/FlattenShirt_EEF_0306_11_news2/29999/params"),
        num_train_steps=30_000,
        lr_schedule = _optimizer.CosineDecaySchedule(decay_steps=30_000),
        checkpoint_base_dir="/pfstem/likaiyu/resources/checkpoints",
    ),
